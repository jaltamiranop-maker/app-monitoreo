...
from infrastructure.database import guardar_pedido, consultar_historial, obtener_detalle_pedido
...
def handle_detallePedido(index):
    try:
        dt = obtener_detalle_pedido(index)
        return dt
    except Exception as e:
        return {"error": str(e)}